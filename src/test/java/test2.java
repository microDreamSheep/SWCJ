...
public class test2 {
    private static final String in = "1:5:#{count}[swcj;]com.midream.sheep.swcj.pojo.image[swcj;]false[swcj;]GET[swcj;]https://pic.netbian.com/index_#{count}.html[swcj;]User-Agent: Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; TencentTraveler 4.0)[swcj;][swcj;][swcj;]10000[swcj;]com.midream.sheep.swcj.core.executetool.execute.jsoup.SWCJJsoup[swcj;]"+"                <Jsoup>\n" +
            "                    <jsoup name=\"name\">\n" +
